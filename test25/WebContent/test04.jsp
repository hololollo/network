		...
		<tbody>
			...
			<tr>
				<td>				
					<p>GET</p>
					<p>보안에 취약 합니다.</p>
					<p>전송할 수 있는 데이터는 최대 255Byte입니다.</p>
					<p>?name=value 의 형식으로 "주소창"에 전달됩니다.</p>
					<p>post 방식에 비해 처리속도는 빠른 편입니다.</p>
					<p>Selvlet에서는 doGet()을 이용합니다.</p>
					<p>주로 a태그를 활용</p>
				</td>
				<td>
					<p>POST</p>
			...
			<table>
				...
				<tbody>
					...
					<tr>
						...
						<td><input type="number" name="birth" id="birth" min="1988" max="2020" value="1992" required></td>
					</tr>
					<tr>
