...
<div>
	...
	<form action="test03_post.jsp" method="post">
		<input type="number" size="40" name="no" id="no" placeholder value="1" min="1" max="100" required><br><br>
		...
		<div>
			...
			<input type="checkbox" name="sports" id="sports2" value="야구"><label for="sports2">야구</label><br><br>
			<input type="checkbox" name="sports" id="sports3" value="배구"><label for="sports3">배구</label><br><br>
			<input type="checkbox" name="sports" id="sports4" value="농구"><label for="sports1">농구</label><br><br>
		</div>
	</form>
</div>
</body>
